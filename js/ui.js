...
export function beanMark(size = 88) {
  ...
  <g transform="rotate(32 256 250)">
    ...
    <path d="M 256 100 C 314 152 210 212 256 254 C 302 296 198 352 256 400" fill="none" stroke="#2A1808" stroke-opacity="0.2" stroke-width="34" stroke-linecap="round" transform="translate(4 5)"/>
    <path d="M 256 100 C 314 152 210 212 256 254 C 302 296 198 352 256 400" fill="none" stroke="#F6EEDA" stroke-width="26" stroke-linecap="round"/>
  </g></svg>`;
}
